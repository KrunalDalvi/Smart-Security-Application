...
class SignUp:
    def __init__(self, root):
        ...
        self.questions['values'] = ("Select","What's your pet name?","Your favorite dish","Your birthplace", "Your favorite movie")
        ...
        self.signup = Button(frame,text="Sign Up",command=self.signup_func,font=("times new roman",17, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=80,y=470,width=150)
        self.log = Button(frame,text="Back to Login",command=self.redirect_login,font=("times new roman",17, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=275,y=470,width=150)
        ...
        if self.fname_txt.get()=="" or self.lname_txt.get()=="" or self.email_txt.get()=="" or self.questions.get()=="Select" or self.answer_txt.get()=="" or self.password_txt.get() == "":
            ...
            try:
                ...
                if row!=None:
                    ...
                    cur.execute("insert into Register (f_name,l_name,email,question,answer,password) values(%s,%s,%s,%s,%s,%s)",
                                    (
                                        self.fname_txt.get(),
                                        self.lname_txt.get(),
                                        self.email_txt.get(),
